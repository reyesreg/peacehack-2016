...
import { SolutionFeed, StatsFeed, PostFeed, AddIssuesPost, PostDetail, HashtagFeed } from './index';
            ...
            <View style={styles.viewContainer}>
                ...
                <View style={styles.mainWrapper}>
                    <View style={styles.viewTabContainer}>
                        <TouchableOpacity style={[styles.btnNav, { backgroundColor: '#098e70' }]}><Icon name="home" size={30} color="#fff" style={styles.btnIcon} /><Text style={styles.btnLabel}>Home</Text></TouchableOpacity>
